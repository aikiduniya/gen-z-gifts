let products = [
  {
    ...
    price: 29.99,
    image_url: 'https://images.unsplash.com/photo-1534796636912-3b95b3ab5986?w=400&h=400&fit=crop',
    category: 'Tech',
    stock: 50,
    is_active: true,
  },
  {
    ...
    price: 24.99,
    image_url: 'https://images.unsplash.com/photo-1515562141589-67f0d569b6e5?w=400&h=400&fit=crop',
    category: 'Jewelry',
    stock: 30,
    is_active: true,
  },
...
let orders = [];
let orderItems = [];
let categories = ['All', 'Tech', 'Jewelry', 'Home', 'DIY'];
let siteSettings = { siteName: 'GenZGifts', currency: 'USD' };
let userRoles = [{ user_id: 1, role: 'admin' }];
let appRoles = ['admin', 'user'];
let users = [
  { id: 1, email: 'admin@genzgifts.com', password: '$2b$10$JHn.badU7Jz2BTRdGD6qye.cj5HbSJBtNyx84MXKCpKax5trRTj5u', isAdmin: true },
  { id: 2, email: 'user@genzgifts.com', password: 'user123', isAdmin: false },
];
let sessions = {}; // simple session store
